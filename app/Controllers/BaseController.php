...
abstract class BaseController {
	...
	protected function redirectIfLoggedIn($redirect = '/') // Change this to the default page for a user
	{
	...
	protected function redirectIfNotLoggedIn($redirect = '/') // Change this to the default page
	{
